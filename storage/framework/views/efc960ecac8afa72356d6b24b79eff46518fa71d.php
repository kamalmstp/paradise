...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <h2 style="margin-top: -10px;"><?php echo e($lims_biller_data->company_name); ?></h2>
        ...
        <p>
            ...
            <?php echo e(trans('file.Date')); ?> : <?php echo e(date('d-m-Y', strtotime($lims_sale_data->created_at))); ?><br>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <br><?php echo e($product_sale_data->qty); ?> x <?php echo e(config('currency')." ".number_format((float)($product_sale_data->total / $product_sale_data->qty))); ?>
                    ...
                    <td style="text-align:right;vertical-align:bottom"><?php echo e(config('currency')." ".number_format((float)$product_sale_data->total)); ?></td>
                </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <th style="text-align:right"><?php echo e(config('currency')." ".number_format((float)$lims_sale_data->total_price)); ?></th>
                </tr>
                <?php if($general_setting->invoice_format == 'gst' && $general_setting->state == 1): ?>
                <tr>
                    <td colspan="2">IGST</td>
                    <td style="text-align:right"><?php echo e(config('currency')." ".number_format((float)$total_product_tax)); ?></td>
                </tr>
                <?php elseif($general_setting->invoice_format == 'gst' && $general_setting->state == 2): ?>
                <tr>
                    <td colspan="2">SGST</td>
                    <td style="text-align:right"><?php echo e(config('currency')." ".number_format((float)($total_product_tax / 2))); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th style="text-align:right"><?php echo e(config('currency')." ".number_format((float)$lims_sale_data->order_tax)); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->order_discount): ?>
                <tr>
                    <th colspan="2"><?php echo e(trans('file.Order Discount')); ?></th>
                    <th style="text-align:right"><?php echo e(config('currency')." ".number_format((float)$lims_sale_data->order_discount)); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->coupon_discount): ?>
                <tr>
                    <th colspan="2"><?php echo e(trans('file.Coupon Discount')); ?></th>
                    <th style="text-align:right"><?php echo e(config('currency')." ".number_format((float)$lims_sale_data->coupon_discount)); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->shipping_cost): ?>
                <tr>
                    <th colspan="2"><?php echo e(trans('file.Shipping Cost')); ?></th>
                    <th style="text-align:right"><?php echo e(config('currency')." ".number_format((float)$lims_sale_data->shipping_cost)); ?></th>
                </tr>
                <?php endif; ?>
                <!-- <tr>
                    <th colspan="2"><?php echo e(trans('file.grand total')); ?></th>
                    <th style="text-align:right"><?php echo e(config('currency')." ".number_format((float)$lims_sale_data->grand_total)); ?></th>
                </tr> -->
                <!-- <tr>
        ...
        <table>
            <tbody>
                ...
                <tr style="background-color:#ddd;">
                    ...
                    <td style="padding: 5px;width:30%"><?php echo e(trans('file.Change')); ?>: <?php echo e(config('currency')." ".number_format((float)$payment_data->change)); ?></td>
                    <td style="padding: 5px;width:40%"><?php echo e(trans('file.Amount')); ?>: <?php echo e(config('currency')." ".number_format((float)$payment_data->amount)); ?></td>
                    
                </tr>                
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr><td class="centered" colspan="3"><?php echo e(trans('file.Thank you for shopping with us. Please come again')); ?> <br><p>@paradise.bdj</p></td></tr>
                <!-- <tr>
...
<?php /**PATH C:\xampp\htdocs\saleproposmajed\resources\views/sale/invoice.blade.php ENDPATH**/ ?>