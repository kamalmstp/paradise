              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number revenue-data"><?php echo e(config('currency')." ".number_format((float)$revenue)); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number return-data"><?php echo e(config('currency')." ".number_format((float)$return)); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number purchase_return-data"><?php echo e(config('currency')." ".number_format((float)$purchase_return)); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number profit-data"><?php echo e(config('currency')." ".number_format((float)$profit)); ?></div>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <?php endif; ?>
                              <td><?php echo e(config('currency')." ".number_format((float)$sale->grand_total)); ?></td>
                            </tr>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <?php endif; ?>
                              <td><?php echo e(config('currency')." ".number_format((float)$purchase->grand_total)); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
                        </table>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <?php endif; ?>
                              <td><?php echo e(config('currency')." ".number_format((float)$quotation->grand_total)); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
                        </table>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo e($key + 1); ?></td>
                          <td></td>
                          <td><?php echo e(config('currency')." ".number_format((float)$sale->total_price)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
                    </table>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saleproposmajed\resources\views/index.blade.php ENDPATH**/ ?>