            ...
            <div class="col-md-6">
                <div class="card">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Total')); ?></span><span id="subtotal"><?php echo e(config('currency')." ".number_format((float)0)); ?></span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Discount')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount"> <i class="dripicons-document-edit"></i></button></span><span id="discount"><?php echo e(config('currency')." ".number_format((float)0)); ?></span>
                                        </div>
                                        <!-- <div class="col-sm-4">
                    ...
                    <div class="payment-amount">
                        <h2><?php echo e(trans('file.grand total')); ?> <span id="grand-total"><?php echo e(config('currency')." ".number_format((float)0)); ?></span></h2>
                    </div>
                    <div class="payment-options">
                        
                        <div class="column-5 col-md-4">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <p id="change" class="ml-2"><?php echo e(config('currency')." ".number_format((float)0)); ?></p>
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <input type="hidden" name="paid_by_id">
                                            <!-- <label><?php echo e(trans('file.Paid By')); ?></label> -->
                                            <input type="hidden" name="paid_by_id_select" value="1">
                                ...
                                <div class="col-md-2 qc" data-initial="1">
                                    ...
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="1000" type="button"><?php echo e(config('currency')." ".number_format((float)1000)); ?></button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="2000" type="button"><?php echo e(config('currency')." ".number_format((float)2000)); ?></button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="5000" type="button"><?php echo e(config('currency')." ".number_format((float)5000)); ?></button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="10000" type="button"><?php echo e(config('currency')." ".number_format((float)10000)); ?></button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="20000" type="button"><?php echo e(config('currency')." ".number_format((float)20000)); ?></button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="50000" type="button"><?php echo e(config('currency')." ".number_format((float)50000)); ?></button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="100000" type="button"><?php echo e(config('currency')." ".number_format((float)100000)); ?></button>
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saleproposmajed\resources\views/sale/pos.blade.php ENDPATH**/ ?>