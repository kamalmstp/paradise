            ...
            <div class="col-md-6">
                <div class="card">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Total')}}</span><span id="subtotal">{{config('currency')." ".number_format((float)0)}}</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Discount')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount"> <i class="dripicons-document-edit"></i></button></span><span id="discount">{{config('currency')." ".number_format((float)0)}}</span>
                                        </div>
                                        <!-- <div class="col-sm-4">
                    ...
                    <div class="payment-amount">
                        <h2>{{trans('file.grand total')}} <span id="grand-total">{{config('currency')." ".number_format((float)0)}}</span></h2>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <p id="change" class="ml-2">{{config('currency')." ".number_format((float)0)}}</p>
                                        </div>
                                        <div class="col-md-6 mt-1">
                                ...
                                <div class="col-md-2 qc" data-initial="1">
                                    ...
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="1000" type="button">{{config('currency')." ".number_format((float)1000)}}</button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="2000" type="button">{{config('currency')." ".number_format((float)2000)}}</button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="5000" type="button">{{config('currency')." ".number_format((float)5000)}}</button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="10000" type="button">{{config('currency')." ".number_format((float)10000)}}</button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="20000" type="button">{{config('currency')." ".number_format((float)20000)}}</button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="50000" type="button">{{config('currency')." ".number_format((float)50000)}}</button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="100000" type="button">{{config('currency')." ".number_format((float)100000)}}</button>
