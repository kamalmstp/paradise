              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number revenue-data">{{config('currency')." ".number_format((float)$revenue)}}</div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number return-data">{{config('currency')." ".number_format((float)$return)}}</div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number purchase_return-data">{{config('currency')." ".number_format((float)$purchase_return)}}</div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number profit-data">{{config('currency')." ".number_format((float)$profit)}}</div>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              @endif
                              <td>{{config('currency')." ".number_format((float)$sale->grand_total)}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              @endif
                              <td>{{config('currency')." ".number_format((float)$purchase->grand_total)}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              @endif
                              <td>{{config('currency')." ".number_format((float)$quotation->grand_total)}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$key + 1}}</td>
                          <td></td>
                          <td>{{config('currency')." ".number_format((float)$sale->total_price)}}</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
